...
| `CL-AI-002` | TypeScript 기반 AI usage intelligence 도구에서 prompt profile·diagnosis·adaptation·drift·LLM-as-Judge를 구조화하고 54 test files, 795 tests로 기능 기준을 검증 | selective | [public repository](https://github.com/tomtomjskim/aiwright) | public `main`에 CI가 없고 dependency·distribution 보강 PR 게시 전이므로 기능 claim에만 사용 |
